...
public class turnimage_change : MonoBehaviour
{
    ...
    public void whos_turn(int n)
    {
        switch (n)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                turn_one_obj.GetComponent<Image>().sprite = Resources.Load("Boss1_face", typeof(Sprite)) as Sprite;
                break;
            case 4:
                turn_one_obj.GetComponent<Image>().sprite = Resources.Load("Boss2_face", typeof(Sprite)) as Sprite;
                break;
            case 5:
                turn_one_obj.GetComponent<Image>().sprite = Resources.Load("Boss3_face", typeof(Sprite)) as Sprite;
                break;
        }
